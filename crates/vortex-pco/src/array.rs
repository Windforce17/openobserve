...
impl PcoData {
    ...
    /// Returns the metadata for the compressed chunks and pages.
    pub fn metadata(&self) -> &PcoMetadata {
        &self.metadata
    }
    ...
    /// Returns the number of rows in the unsliced array.
    pub fn unsliced_n_rows(&self) -> usize {
        self.unsliced_n_rows
    }
}
