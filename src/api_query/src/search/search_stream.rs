...
pub async fn search_http2_stream(
    ...
    if is_ui_histogram {
        ...
        // preset histogram_interval) and emitted explicitly — the streaming
        // partitions re-plan this SQL over narrower sub-ranges and must all
        // share the full-range bucket width.
