...
mod tests {
    ...
    fn test_different_time_ranges_produce_different_intervals() {
        ...
        let mut v1 = HistogramIntervalVisitor::new((0, hour));
        ...
        let mut statement = parse(sql);
        let mut v3 = HistogramIntervalVisitor::new((0, hour));
    ...
    fn test_validate_adjust_preserves_valid_interval_regardless_of_time_range() {
        ...
        assert_eq!(
            validate_and_adjust_histogram_interval(preset, (0, hour)),
            30
        );
        assert_eq!(
